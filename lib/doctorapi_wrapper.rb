...
module DoctorapiWrapper
  class Client
    ...
    def doctors(params = {})
      data = get request(endpoint: "doctors", params: params)
    ...
    def update_patient_account(body)
      put request(endpoint: "patient/account", body: body)
    end

    def get_patient_account
      data = get request(endpoint: "patient/account")
      Data.new(data)
    end

    def assign_patient_to_doctor(body)
      data = post request(endpoint: "patient/assignments", body: body)
      Data.new(data)
    end
